...
// ---------- Official branch directory (36 active branches) ----------
...
const BRANCHES = [
  { name: "Kwatogs Lipa — Main (Inosluban)", city: "Lipa City", province: "Batangas",
    ...
    hours: { alwaysOpen: true }, since: 2018, badge: "★ Original Branch",
  ...
  { name: "Kwatogs Lipa — Sabang", city: "Lipa City", province: "Batangas",
    ...
    hours: { alwaysOpen: true }, since: 2022, badge: "Open 24/7" },
  ...
  { name: "Kwatogs Tanauan — Darasa", city: "Tanauan City", province: "Batangas",
    ...
    hours: { open: "06:30", close: "00:00" }, since: 2023 },
  ...
  { name: "Kwatogs San Pablo — San Nicolas", city: "San Pablo City", province: "Laguna",
    ...
    hours: { open: "06:00", close: "23:30" }, since: 2023 },
  ...
  { name: "Kwatogs SM City Sto. Tomas", city: "Sto. Tomas", province: "Batangas",
    ...
    hours: { open: "10:00", close: "20:30" }, since: 2023, badge: "Mall Branch" },
  ...
  { name: "Kwatogs San Pablo — Calihan", city: "San Pablo City", province: "Laguna",
    ...
    hours: { open: "10:00", close: "23:00" }, note: "Open until 12 AM on weekends", since: 2024 },
  ...
  { name: "Kwatogs Candelaria", city: "Candelaria", province: "Quezon",
    ...
    hours: { open: "08:00", close: "23:00" }, since: 2024 },
  ...
  { name: "Kwatogs San Pablo — Del Remedio", city: "San Pablo City", province: "Laguna",
    ...
    hours: { open: "08:00", close: "23:30" }, since: 2024 },
  ...
  { name: "Kwatogs Calamba — Burgos", city: "Calamba City", province: "Laguna",
    ...
    hours: { open: "09:00", close: "23:00" }, since: 2024 },
  ...
  { name: "Kwatogs Lucena — Poblacion", city: "Lucena City", province: "Quezon",
    ...
    hours: { open: "06:00", close: "23:20" }, since: 2024 },
  ...
  { name: "Kwatogs Santa Rosa", city: "Santa Rosa City", province: "Laguna",
    ...
    hours: { open: "10:00", close: "23:00" }, since: 2024 },
  ...
  { name: "Kwatogs Canlubang", city: "Calamba City", province: "Laguna",
    ...
    hours: { open: "08:00", close: "20:30" }, since: 2024, badge: "Mall Branch" },

  { name: "Kwatogs Robinsons Lipa", city: "Lipa City", province: "Batangas",
    address: "Robinsons Lipa Food Court, Lipa City, Batangas", phone: "",
    hours: { unknown: true }, since: 2024, badge: "Mall Branch" },

  { name: "Kwatogs Calamba — Bucal", city: "Calamba City", province: "Laguna",
    address: "Kristine's Bldg., National Highway, Brgy. Bucal, Calamba City, Laguna", phone: "0962-352-6433",
    hours: { open: "10:00", close: "23:00" }, since: 2025 },

  { name: "Kwatogs Padre Garcia", city: "Padre Garcia", province: "Batangas",
    address: "408 P. Torres St., San Felipe, Padre Garcia, Batangas", phone: "0977-819-8785",
    hours: { open: "09:00", close: "21:00" }, since: 2025 },
  ...
  { name: "Kwatogs Molino", city: "Bacoor", province: "Cavite",
    ...
    hours: { open: "16:00", close: "03:00" }, since: 2025, badge: "Open Late",
  ...
  { name: "Kwatogs Santa Cruz", city: "Santa Cruz", province: "Laguna",
    ...
    hours: { open: "09:00", close: "23:00" }, since: 2025 },

  { name: "Kwatogs Batangas — Bolbok", city: "Batangas City", province: "Batangas",
    address: "Purok 3, Bolbok (Diversion), Batangas City", phone: "0927-067-0715",
    hours: { open: "06:00", close: "23:30" }, since: 2025 },
  ...
  { name: "Kwatogs Los Baños", city: "Los Baños", province: "Laguna",
    ...
    hours: { open: "10:00", close: "22:00" }, since: 2025 },

  { name: "Kwatogs Imus", city: "Imus City", province: "Cavite",
    address: "Punasin, Anabu II-A, Imus, Cavite", phone: "0963-948-0292",
    hours: { open: "11:00", close: "23:00" }, since: 2025 },

  { name: "Kwatogs Lucena 2 — Enverga", city: "Lucena City", province: "Quezon",
    address: "Enverga University Blvd., Ibabang Dupay, Lucena City, Quezon", phone: "",
    hours: { unknown: true }, since: 2025 },

  { name: "Kwatogs Santiago", city: "Santiago City", province: "Isabela",
    address: "Maharlika Highway, Dubinan, Santiago City, Isabela", phone: "",
    hours: { unknown: true }, since: 2025, badge: "Farthest North" },

  { name: "Kwatogs San Pedro", city: "San Pedro City", province: "Laguna",
    address: "San Pedro, Laguna", phone: "",
    hours: { unknown: true }, since: 2025 },
  ...
  { name: "Kwatogs Silang", city: "Silang", province: "Cavite",
    ...
    hours: { open: "10:00", close: "23:00" }, since: 2026, badge: "New!" },

  { name: "Kwatogs Batangas — Gulod", city: "Batangas City", province: "Batangas",
    address: "Gulod Labac, Batangas City", phone: "",
    hours: { unknown: true }, since: 2026, badge: "New!" },

  { name: "Kwatogs General Trias", city: "General Trias City", province: "Cavite",
    address: "C.M. Delos Reyes St., Brgy. Manggahan, General Trias, Cavite", phone: "",
    hours: { unknown: true }, since: 2026, badge: "New!" },

  { name: "Kwatogs San Pascual", city: "San Pascual", province: "Batangas",
    address: "San Pascual, Batangas", phone: "",
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Demo form handling (prototype only — wire to a real endpoint at launch)
